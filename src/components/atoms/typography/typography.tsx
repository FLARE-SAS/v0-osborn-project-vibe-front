...
interface TypographyProps {
  variant: "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "p" | "span" | "label" | "thead" | "captionMedium"
  children?: ReactNode
  className?: string
  htmlFor?: string
}
...
const variantStyles: Record<TypographyProps["variant"], string> = {
  ...
  captionMedium: "font-mulish caption-medium",
}

export function Typography({ variant, children, className, htmlFor }: TypographyProps) {
